...
%           ddwdLtdLz_e = (M_e/rho_s)*ddWeddLn(L_t*G_et, L_z*G_ez, 3, c_e)*G_et*G_ez;
        ...
        ncauchy_stress = ((sigma_ck(1)+sigma_ck(2)+sigma_ck(3)+sigma_ck(4)+T_t_m)/(sigma_ch+sigma_mh)) - 1.0;
  ...
  %         M_ck(3)/M_ckh(3)*rm_c_dtauversion(1, m_basal_ck(3), nc_stress(3), dn_tau, K_c1, K_c2), ...
   %        M_ck(4)/M_ckh(4)*rm_c_dtauversion(1, m_basal_ck(4), nc_stress(4), dn_tau, K_c1, K_c2)];
    %    m_m = M_m/M_mh*rm_m_dtauversion(1, m_basal_m, nm_stress, dn_tau, K_m1, K_m2);
        ...
        m_c = [M_ck(1)/M_ckh(1)*rm_c_dtauversion(1, m_basal_ck(1), ncauchy_stress, dn_tau, K_c1, K_c2),...
           M_ck(2)/M_ckh(2)*rm_c_dtauversion(1, m_basal_ck(2), ncauchy_stress, dn_tau, K_c1, K_c2),...
           M_ck(3)/M_ckh(3)*rm_c_dtauversion(1, m_basal_ck(3), ncauchy_stress, dn_tau, K_c1, K_c2), ...
           M_ck(4)/M_ckh(4)*rm_c_dtauversion(1, m_basal_ck(4), ncauchy_stress, dn_tau, K_c1, K_c2)];
        m_m = M_m/M_mh*rm_m_dtauversion(1, m_basal_m, ncauchy_stress, dn_tau, K_m1, K_m2);
